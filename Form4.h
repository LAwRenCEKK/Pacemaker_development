...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(274, 207);
			...
			this->comboBox1->Items->AddRange(gcnew cli::array< System::Object^  >(18) { L"AAT", L"VVT", L"AOO", L"AAI", L"VOO", L"VVI", L"VDD", L"DOO", L"DDI", L"DDD", L"AOOR", L"AAIR", L"VOOR", L"VVIR", L"VDDR", L"DOOR", L"DDIR", L"DDDR"
			});
			this->comboBox1->Location = System::Drawing::Point(17, 47);
			...
			this->label1->Text = L"Select Pacemaker Mode :";
			// 
			// button2
			// 
			this->button2->Location = System::Drawing::Point(17, 148);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(97, 34);
			this->button2->TabIndex = 3;
			this->button2->Text = L"Add Mode";
			...
			this->label2->Text = L"Add Pacermaker Mode :";
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(17, 120);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(120, 148);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(104, 34);
			this->button3->TabIndex = 6;
			this->button3->Text = L"Delete Mode";
			this->button3->UseVisualStyleBackColor = true;
			this->button3->Click += gcnew System::EventHandler(this, &Form4::button3_Click);
			// 
			// button4
			// 
			this->button4->Location = System::Drawing::Point(175, 41);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(104, 34);
			this->button4->TabIndex = 7;
			this->button4->Text = L"Next Step";
